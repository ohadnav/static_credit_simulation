...
INVENTORY_TURNOVER_RATIO_BENCHMARK_MIN = 1
INVENTORY_TURNOVER_RATIO_MEDIAN = 4
INVENTORY_TURNOVER_RATIO_BENCHMARK_MAX = 10
...
FIRST_BATCH_STD_FACTOR = 3

# Sales
INITIAL_CASH_RATIO = 0.01
INITIAL_CASH_STD = EXTREME_STD
MEDIAN_PRICE = 20.0
...
PROFIT_MARGIN_ADJUSTMENT = 0
MIN_RISK_SCORE = 0.4
DEFAULT_RISK_MIN_THRESHOLD = 0.2
LOW_UNDERWRITING_SENSITIVITY = 1
MEDIUM_UNDERWRITING_SENSITIVITY = 2
HIGH_UNDERWRITING_SENSITIVITY = 4
