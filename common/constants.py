...
# Inventory
SHIPPING_DURATION_MAX = 55
SHIPPING_DURATION_MIN = 22
SHIPPING_DURATION_STD = 0.5
MIN_SHIPPING_DURATION = 7
MIN_MANUFACTURING_DURATION = 7
MANUFACTURING_DURATION_MIN = 30
MANUFACTURING_DURATION_MAX = 60
MANUFACTURING_DURATION_STD = 0.5
MAX_LEAD_TIME = MANUFACTURING_DURATION_MAX + SHIPPING_DURATION_MAX
COGS_MARGIN_BENCHMARK_MIN = 0.4
COGS_MARGIN_BENCHMARK_MAX = 0.7
COGS_MARGIN_BENCHMARK_AVG = (COGS_MARGIN_BENCHMARK_MIN + COGS_MARGIN_BENCHMARK_MAX) / 2
COGS_MARGIN_MAX = 0.8
