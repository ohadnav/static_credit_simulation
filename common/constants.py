...
EXPECTED_LOANS_PER_YEAR = 3.0
MAX_RESULTS_WEIGHT = 10 ** 8
WHALE_GROWTH_CAGR = 10.0
NUM_RISK_ORDERS = 5
...
ACCOUNT_SUSPENSION_DURATION = 90
...
MIN_RISK_SCORE = 0.4
DEFAULT_RISK_MIN_THRESHOLD = 0.1
